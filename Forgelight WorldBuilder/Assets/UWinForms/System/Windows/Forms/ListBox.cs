namespace UWinForms.System.Windows.Forms
{
    ...
    public class ListBox : ListControl
    {
        ...
        private global::UWinForms.Unity.UnityWinForms.invokeAction keyFilterIA;
            ...
            switch (e.uwfKeyArgs.KeyCode)
            {
                ...
                default:
                    ...
                    if (char.IsLetterOrDigit(c) || char.IsPunctuation(c))
                    {
                        ...
                        if (keyFilterIA == null)
                            keyFilterIA = global::UWinForms.Unity.UnityWinForms.Invoke(ResetKeyFilter, keyFilterResetTime);

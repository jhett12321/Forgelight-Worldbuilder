namespace UWinForms.Unity.API
{
    ...
    using Core.API;
    using global::System;
    using Color = global::UWinForms.System.Drawing.Color;
    using Font = global::UWinForms.System.Drawing.Font;
    using FontStyle = global::UWinForms.System.Drawing.FontStyle;
    ...
    public class UnityGdi : IApiGraphics
    {
        ...
        public void DrawRectangle(Pen pen, float x, float y, float width, float height, object material = null)
        {
            ...
            switch (penDash)
            {
                case global::UWinForms.System.Drawing.Drawing2D.DashStyle.Solid:
                    ...
                    break;
                case global::UWinForms.System.Drawing.Drawing2D.DashStyle.Dash:
                    float dash_step = penWidth * 6;
                    for (float i = 0; i < width; i += dash_step)
                    {
                        float dash_width = dash_step - 2;

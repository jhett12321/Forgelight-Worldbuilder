namespace WorldBuilder.Utils
{
    ...
    {
        public static float Remap01(this float value, float targetMin, float targetMax) => value.Remap(0, 1, targetMin, targetMax);
        ...
        public static Vector3 ToRadians(this Vector3 eulerAngles) => new Vector3(eulerAngles.x * Mathf.Deg2Rad, eulerAngles.y * Mathf.Deg2Rad, eulerAngles.z * Mathf.Deg2Rad);
